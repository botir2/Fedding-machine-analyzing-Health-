...
def hlgood(hlgood):
    global result_hlgood
    result_hlgood = hlgood


def hlwarming(hlwarming):
    global result_hlwarming
    result_hlwarming = hlwarming
...
if __name__ == "__main__":
    ...
    while True:
        L1 = int(input('Input your K days:'))
        if not L1 < 0:
            break
                    ...
                    if data is not False:
                        ...
                        try:
                            ...
                            if data[0]== 0:
                                ...
                                resting_count+=5
                                print(count, resting_count, standing_count, walking_count, running_count, result_hlgood,
                                      result_hlwarming, result_hlbad)
                            if count == 59:
                                #InsertDB(target_address, 110, 120, 163, 45, "good", datetime.now())
                                InsertDB(target_address, resting_count, standing_count, walking_count, running_count,
                                         result_hlgood, result_hlwarming, result_hlbad, datetime.now())
                                count = -1
                                standing_count = 0
                                walking_count = 0
                                running_count = 0
